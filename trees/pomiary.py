...
def get_avl_time_insert(numbers, how_many):
    gc_old = gc.isenabled()
    gc.disable()
    ...
    avl_tree = AVL_Tree()
    root = None
    list_numbers = numbers[0: how_many]
...
def get_bst_time_insert(numbers, how_many):
    gc_old = gc.isenabled()
    gc.disable()
    start = time.process_time()
...
def get_bst_time_find(numbers, how_many):
    ...
    for i in range(0, how_many):
        bst_tree.Root_Node.find(numbers[i])
...
def measure_times_of_inserting(numbers, ranges):
    ...
    avl_time_insert = []
    for num in ranges:
        bst_time_insert.append(get_bst_time_insert(numbers, num))
        avl_time_insert.append(get_avl_time_insert(numbers, num))
...
if __name__ == "__main__":
    ...
    print("\nINSERT")
    print("bst:")
    print(bst_time_insert)
    print("avl:")
    print(avl_time_insert)
    print("\nDELETE")
    print("bst:")
    print(bst_time_delete)
    print("avl:")
    print(avl_time_delete)
    print("\nFIND")
    print("bst:")
    print(bst_time_find)
    print("avl:")
    ...
    # tymczasowo zakomentowane polecenia rysowania wykresów
